                                          ...
                                          children: <Widget>[
                                              ListTile(
                                                  ...
                                                  leading: CircleAvatar(
                                                      backgroundImage:
                                                      AssetImage(model.products[position]
                                                              .productImage),
                                                      radius: 30.0,
                                                  ),
                                                  subtitle: Text(model.products[position]
                                                          .productDesc),
                                                  contentPadding: EdgeInsets.all(8.0),
                                                  trailing: _buildIconButton(context, model
                                                          .products[position]),
                                              ),
                                              Divider()
                                          ],
        ...
        onPressed: () {
            Navigator.of(context).push(MaterialPageRoute(
                builder: (BuildContext context) {
                    return ProductCreateOrEditPage(productToEdit: product,);
                },
            ));
        },
    );
