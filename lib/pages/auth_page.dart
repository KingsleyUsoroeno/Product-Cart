    ...
    loginUser() {
        if (_formKey.currentState.validate()) {
            ...
            if (_formData["acceptTerms"] == false) {
                Fluttertoast.showToast(msg: "Please Accept terms and Conditions to login",
                        toastLength: Toast.LENGTH_LONG, backgroundColor: Colors
                                .red, textColor: Colors.white, gravity: ToastGravity.BOTTOM);
                        ...
                        decoration: BoxDecoration(
                                image: DecorationImage(
                                        ...
                                        colorFilter: ColorFilter.mode(
                                                Colors.black12.withOpacity(0.3), BlendMode
                                                .dstATop))),
